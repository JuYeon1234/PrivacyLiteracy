        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="createclass.html">교실생성</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#download">설치하기</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#creatclass">결과확인(선생님전용)</a>
                    </li>
                </ul>
            </div>	<!-- .navbar-collapse -->
        </div>		<!-- .container -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
					...
					<p>&nbsp;</p>
                    <a class="btn btn-primary page-scroll" href="#about">설치하기</a>
                </div>
            </div>
        </div>
    </section>
